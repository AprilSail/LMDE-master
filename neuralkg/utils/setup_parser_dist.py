...
def setup_parser():
    ...
    parser.add_argument('--use_weight', default=True, action='store_true')
    parser.add_argument("--seed", default=321, type=int)
    parser.add_argument("--litmodel_name", default="distil_KGELitModel", type=str)
    parser.add_argument('--model_name', default="ComplEx", type=str)
    parser.add_argument('--loss_name', default="PLM_DE_Loss", type=str)
    parser.add_argument('--dataset_name', default="WN18RR", type=str)
    parser.add_argument('--optim_name', default="Adam", type=str)
    parser.add_argument('--margin', default=6.0, type=float)
    parser.add_argument('--checkpoint_dir', default="", type=str)
    parser.add_argument('--regularization', '-r', default=5e-6, type=float)  # 后续尝试使用optim的正则化方法
    ...
    parser.add_argument('--check_per_epoch', default=20, type=int)  # test per epoch
    parser.add_argument('--early_stop_patience', default=100, type=int)
    parser.add_argument('--temperature', default=7, type=int)  # 蒸馏温度
    parser.add_argument('--emb_dim', default=32, type=int)  # 蒸馏后的学生模型的规模
    parser.add_argument('--out_dim', default=200, type=int)
    parser.add_argument('--num_neg', default=1024, type=int)
    ...
    parser.add_argument('--adv_temp', default=0.6, type=float)
    ...
    # parser for distilE
    parser.add_argument('--stage2', default=False, action='store_true')
    parser.add_argument('--teacher_dim', default=512, type=int)
    # parser.add_argument('--litmodel_tea_name', type=str)
    ...
    parser.add_argument("--update_axiom_per", default=1, type=int, help='in IterELitModel.py')
