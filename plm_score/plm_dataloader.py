...
class DataLoader(object):
    def __init__(self, in_paths, tokenizer, batch_size=16, neg_rate=1, max_desc_length=512, add_tokens=False,
                 p_tuning=False, rdrop=False, model='bert'):
        ...
        self.whole_set = self.train_set

        self.uid2text = {}
        self.uid2tokens = {}

        self.entity_set = set([t[0] for t in self.train_set] + [t[-1] for t in self.train_set])
        self.relation_set = set([t[1] for t in self.train_set])
